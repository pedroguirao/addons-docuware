...
class ResCompany(models.Model):
    ...
    docuware_cabinet_read_id = fields.Many2one('docuware.cabinets', string='Docuware Dir')
    docuware_cabinet_write_id = fields.Many2one('docuware.cabinets', string='Upload Cabinet')
    mandatory_field_ids = fields.One2many('docuware.fields', 'company_id', string='Docuware VAT',
